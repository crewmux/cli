...
ln -sf "$INSTALL_DIR/crewmux" "$INSTALL_DIR/cm"
ln -sf "$INSTALL_DIR/crewmux" "$INSTALL_DIR/ai"
ok "Installed $INSTALL_DIR/crewmux"
ok "Created legacy alias $INSTALL_DIR/cm -> $INSTALL_DIR/crewmux"
ok "Created legacy alias $INSTALL_DIR/ai -> $INSTALL_DIR/crewmux"
