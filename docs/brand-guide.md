...
- 핵심 테마: crew coordination + tmux pane multiplexing
- 아이콘: pane grid와 helm을 결합한 조정 심볼
- 마스코트: 여러 작업 패널을 관리하는 captain 캐릭터
...
- 다크 UI에서는 아이콘 원본을 그대로 쓰고, 밝은 배경에서는 16px 이상의 여백을 두는 편이 안정적임
